...
This folder contains notebooks focused on understanding the data, feature exploration, and diagnostic analysis.
...
## Purpose
These notebooks help understand the dataset characteristics, identify important features, and guide modeling decisions for both text-only and multimodal approaches.
